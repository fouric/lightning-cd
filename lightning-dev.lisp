(defun lightning-dev ()
  (flet ((emacsclient-eval (command)
    ...
    (funcall (intern "QUICKLOAD" :ql) '(:lightning-cd :trivial-shell) :silent t)
    (emacsclient-eval (format nil "(find-file \\\"~a\\\")" (namestring (asdf:system-relative-pathname :lightning-cd "src/lightning-cd.lisp"))))
